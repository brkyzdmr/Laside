...
class Ui_DictionaryScreen(object):
    def setupUi(self, DictionaryScreen):
        ...
        DictionaryScreen.resize(500, 400)
        DictionaryScreen.setMinimumSize(QtCore.QSize(500, 400))
        DictionaryScreen.setMaximumSize(QtCore.QSize(500, 400))
        font = QtGui.QFont()
        ...
        self.tw_wordtable.setColumnCount(3)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tw_wordtable.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, DictionaryScreen):
        ...
        item.setText(_translate("DictionaryScreen", "Id"))
        item = self.tw_wordtable.horizontalHeaderItem(1)
        item.setText(_translate("DictionaryScreen", "New Column"))
        item = self.tw_wordtable.horizontalHeaderItem(2)
